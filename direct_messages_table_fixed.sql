...
-- Updated to work with the 'team' table structure
...
COMMENT ON COLUMN direct_messages.sender_id IS 'ID of the auth user who sent the message';
COMMENT ON COLUMN direct_messages.recipient_id IS 'ID of the auth user who received the message';
