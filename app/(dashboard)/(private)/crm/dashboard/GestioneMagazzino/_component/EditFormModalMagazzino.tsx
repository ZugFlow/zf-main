...
const EditFormModal: React.FC<EditFormModalProps> = ({ isDialogOpen, setIsDialogOpen, productId }) => {
  ...
  const handleSubmit = async (values: { [key: string]: any }) => {
    try {
      ...
      if (error) {
        ...
        alert("Errore nell'aggiornamento del prodotto. Controlla la console per maggiori dettagli.");
      } else {
