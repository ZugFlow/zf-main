-- =====================================================
-- SISTEMA COMPLETO PRENOTAZIONI ONLINE (STRUTTURA FINALE CORRETTA)
-- =====================================================
...
-- =====================================================
-- 2. TABELLA ORARI DI LAVORO (STRUTTURA FINALE CORRETTA)
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_working_hours_salon_team ON working_hours(salon_id, team_member_id);
...
CREATE INDEX IF NOT EXISTS idx_extra_schedules_salon_team ON extra_schedules(salon_id, team_member_id);
