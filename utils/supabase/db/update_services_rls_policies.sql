-- Script per AGGIORNARE le policy RLS della tabella services
...
-- Rimuovi tutte le policy esistenti per services
...
-- Rimuovi i trigger esistenti per services
...
SELECT 'Policy RLS per services aggiornate con successo!' as status;
