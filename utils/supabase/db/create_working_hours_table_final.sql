-- =====================================================
-- CREAZIONE TABELLA WORKING_HOURS (STRUTTURA FINALE CORRETTA)
-- =====================================================
...
CREATE TABLE IF NOT EXISTS working_hours (
  ...
  UNIQUE(salon_id, team_id, day_of_week)
);

-- Indici per ottimizzare le query
CREATE INDEX IF NOT EXISTS idx_working_hours_salon_team ON working_hours(salon_id, team_id);
...
COMMENT ON COLUMN working_hours.team_id IS 'ID del membro del team (riferimento a team.id)';
