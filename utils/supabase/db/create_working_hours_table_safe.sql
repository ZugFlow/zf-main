-- =====================================================
-- CREAZIONE TABELLA WORKING_HOURS (VERSIONE SICURA)
-- =====================================================
-- Tabella per gli orari di lavoro settimanali dei membri del team
-- Gestisce il caso in cui trigger e funzioni esistono già
-- =====================================================
...
-- Indici per ottimizzare le query (solo se non esistono)
DO $$
BEGIN
...
-- Funzione per aggiornare automaticamente updated_at (solo se non esiste)
...
-- Trigger per working_hours (solo se non esiste)
DO $$
BEGIN
...
COMMENT ON COLUMN working_hours.team_member_id IS 'ID del membro del team (riferimento a team.id)';
