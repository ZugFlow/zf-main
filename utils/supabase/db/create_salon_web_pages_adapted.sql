-- =====================================================
-- SISTEMA PAGINE WEB SALONI - VERSIONE ADATTATA
-- =====================================================
-- Questo script implementa il sistema di pagine web per saloni
-- adattato alla struttura esistente del database senza tabella salon separata
-- Utilizza salon_id come identificatore univoco del salone
...
COMMENT ON FUNCTION enable_salon_web_page IS 'Abilita la pagina web di un salone con verifica autorizzazioni (adattato)';
COMMENT ON FUNCTION disable_salon_web_page IS 'Disabilita la pagina web di un salone (adattato)';
COMMENT ON FUNCTION update_salon_web_settings IS 'Aggiorna le impostazioni della pagina web (adattato)';
COMMENT ON FUNCTION add_salon_gallery IS 'Aggiunge una galleria al salone (adattato)';
COMMENT ON FUNCTION add_salon_testimonial IS 'Aggiunge un testimonial al salone (adattato)';
COMMENT ON FUNCTION record_page_visit IS 'Registra una visita alla pagina web (adattato)';
COMMENT ON FUNCTION get_salon_web_stats IS 'Ottiene statistiche della pagina web del salone (adattato)';
...
DO $$
BEGIN
    RAISE NOTICE 'Sistema pagine web saloni ADATTATO installato con successo!';
